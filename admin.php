                    ...
                    <div class="modal-body">
                        <form id="formAsignarClase">
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    <label for="instructor" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                                ...
                                <div class="col-md-6">
                                    <label for="fecha" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    <label for="hora_inicio" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                                        <i class="fas fa-clock text-secondary"></i>Start Time 
                                    </label>
                                    <input type="time" id="hora_inicio" class="form-control" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="hora_fin" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-4">
                                    <label for="alumno_nombre" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                                        <i class="fas fa-user text-muted"></i>Name 
                                    </label>
                                    <input type="text" id="alumno_nombre" class="form-control" required name="alumno">
                                </div>
                                <div class="col-md-4">
                                    <label for="alumno_telefono" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                                        <i class="fas fa-phone text-success"></i>Phone
                                    </label>
                                    <input type="tel" id="alumno_telefono" class="form-control" name="telefono_alumno">
                                </div>
                                <div class="col-md-4">
                                    <label for="alumno_email" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-3">
                                    <label for="pago_efectivo" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                                ...
                                <div class="col-md-3">
                                    <label for="pago_tarjeta" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                                ...
                                <div class="col-md-3">
                                    <label for="total_pagado" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                                ...
                                <div class="col-md-3">
                                    <label for="tarifa_profesor" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                              ...
                              <div class="mb-3">
                                <label for="observaciones" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formEditarClase">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    <label for="edit_profesor" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                                        <i class="fas fa-chalkboard-teacher text-primary"></i>Instructor 
                                    </label>
                                    <select id="edit_profesor" class="form-select" required name="editar_profesor"></select>
                                </div>
                                <div class="col-md-6">
                                    <label for="edit_fecha" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                                        <i class="fas fa-calendar-alt text-primary"></i>Date 
                                    </label>
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    <label for="edit_hora_inicio" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                                        <i class="fas fa-clock text-secondary"></i>Start Time 
                                    </label>
                                    <input type="time" id="edit_hora_inicio" class="form-control" required name="editar_hora_inicio">
                                </div>
                                <div class="col-md-6">
                                    <label for="edit_hora_fin" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                                        <i class="fas fa-clock text-secondary"></i>End Time 
                                    </label>
...
<h6 class="section-title">Participant Information</h6>
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-4">
                                    <label for="edit_alumno_nombre" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                                        <i class="fas fa-user text-muted"></i>Name 
                                    </label>
                                    <input type="text" id="edit_alumno_nombre" class="form-control" required name="editar_alumno">
                                </div>
                                <div class="col-md-4">
                                    <label for="edit_alumno_telefono" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                                        <i class="fas fa-phone text-success"></i>Phone
                                    </label>
                                    <input type="text" id="edit_alumno_telefono" class="form-control" name="editar_telefono_alumno">
                                </div>
                                <div class="col-md-4">
                                    <label for="edit_alumno_email" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                                        <i class="fas fa-envelope text-primary"></i>Email
                                    </label>
...
<h6 class="section-title">Payment Details</h6>
                            <div class="row g-3 mb-3">
                                <div class="col-md-3">
                                    <label for="edit_pago_efectivo" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                                        <i class="fas fa-money-bill-wave text-success"></i>Cash
                                    </label>
                                ...
                                <div class="col-md-3">
                                    <label for="edit_pago_tarjeta" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                                        <i class="fas fa-credit-card text-danger"></i>Card
                                    </label>
                                ...
                                <div class="col-md-3">
                                    <label for="edit_total_pagado" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                                        <i class="fas fa-dollar-sign text-info"></i>Total Paid
                                    </label>
                                    <input type="number" id="edit_total_pagado" class="form-control" name="editar_importe_pagado" readonly>
                                </div>
                                <div class="col-md-3">
                                    <label for="edit_tarifa_profesor" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                                        <i class="fas fa-receipt text-secondary"></i>Instructor Fee 
                                    </label>
...
<h6 class="section-title">Additional Notes</h6>
                            <div class="mb-3">
                                <label for="edit_observaciones" class="d-flex align-items-center gap-1 mb-1" style="min-height: 1.8rem;">
                                    <i class="fas fa-sticky-note text-muted"></i>Notes
                                </label>
